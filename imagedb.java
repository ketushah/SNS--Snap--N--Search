...
public class imagedb {
  ...
  public static void main(String[] args) 
  {
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/SNS", "root", "root");
	...
	Document doc;
		...
		{  
				...
				imgfile = new File("image"+i+".jpg");
	
	fin = new FileInputStream(imgfile);
	pre =con.prepareStatement("insert into images values(?,?,?)");
		   pre.setString(2,"Image1");
